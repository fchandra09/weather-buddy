...
class Application
{
	...
	private function checkLoggedIn()
	{
		if (!is_numeric($GLOBALS["beans"]->siteHelper->getSession("userID")))
		{
			...
			$validDestination = $validDestination || (strcasecmp("user", $this->url_controller) == 0 && strlen($this->url_action) == 0);
			$validDestination = $validDestination || (strcasecmp("user", $this->url_controller) == 0 && strcasecmp("index", $this->url_action) == 0);
			...
			$validDestination = $validDestination || (strcasecmp("home", $this->url_controller) == 0 && strcasecmp("setDefaultLocation", $this->url_action) == 0);
			$validDestination = $validDestination || (strcasecmp("home", $this->url_controller) == 0 && strcasecmp("getDefaultLocation", $this->url_action) == 0);
